...
const milestoneCompliments = {
  ...
  100: chalk.bold.green("🎉 Welcome to the Century Club! Your commitment is legendary. 🎉"),
  500: chalk.bold.blue("🎉 500 commits! If commits were miles, you'd have just crossed a continent. 🎉"),
  1000: chalk.bold.red("🎉 1000 commits! You're not just coding; you're making history. Here's to 1000 more moments of brilliance! 🎉"),
};
...
if (milestones.includes(commitCount)) {
  console.log(milestoneCompliments[commitCount]);
}
