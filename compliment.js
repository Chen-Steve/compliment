...
(async () => {
  ...
  const compliments = [
    ...
    chalk
      .rgb(255, 136, 0)
      .bold("You commit like Picasso paints: often and with passion!"),
  ...
  const milestoneCompliments = {
    10: chalk.bold.yellow(
      "🎉 Double digits! You're not just playing the game; you're changing it. 🎉"
    ),
    50: chalk.bold.magenta(
      "🎉 50 commits! You're half a centurion in the coding colosseum! 🎉"
    ),
